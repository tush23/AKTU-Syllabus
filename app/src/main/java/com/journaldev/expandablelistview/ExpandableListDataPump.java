...
public class ExpandableListDataPump {
    public static HashMap<String, List<String>> getData() {
        ...
        cricket1.add(micropr);

        List<String> osss = new ArrayList<String>();
        ...
        expandableListDetail.put("OPERATING SYSTEMS", osss);
        expandableListDetail.put("SOFTWARE ENGINEERING", see);
